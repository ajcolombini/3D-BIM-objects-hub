...
{
    public class clsValidationUtil
    {
        /// <summary>
        /// ValidaCPF 
        /// </summary>
        /// <param name="nrCPF">Numero com ou sem Formatacao</param>
        /// <returns></returns>
        public static bool ValidaCPF(string nrCPF)
        {

            if (nrCPF == "")
                return false;

            string cpf = clsTextoUtil.ExtractNumbers(nrCPF);
        ...
        /// Valida CNPJ
        /// </summary>
        /// <param name="nrCNPJ">Numero com ou sem Formatacao</param>
        /// <returns></returns>
        public static bool ValidaCNPJ(string nrCNPJ)
        {
            string CNPJ = clsTextoUtil.ExtractNumbers(nrCNPJ);
