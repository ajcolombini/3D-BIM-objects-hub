...
<head>
    ...
    <script>
        // Initialize Firebase
        var config = {
            apiKey: "AIzaSyA3LGLgBNc9mxQEPDqSg9GzqKhsIUtW0lI",
            authDomain: "dhub-4bd37.firebaseapp.com",
            databaseURL: "https://dhub-4bd37.firebaseio.com",
            storageBucket: "dhub-4bd37.appspot.com",
            messagingSenderId: "495659137905"
        };
    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Main.aspx">Admin Panel</a>
            </div>
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active"><a href="Main.aspx"><i class="fa fa-bullseye"></i>Dashboard</a></li>
