...
(function ($) {
    ...
    $.fn.fileinputLocales['pt-BR'] = {
        ...
        msgNo: 'Não',
        msgNoFilesSelected: 'Sem arquivos selecionados',
        ...
        msgUploadEnd: 'Pronto',
        msgUploadEmpty: 'Sem dados válidos disponíveis para upload.',
        ...
        msgAjaxError: 'Algo deu errado com a operação {operation}. Por favor, tente novamente depois!',
        msgAjaxProgressError: 'falha ao {operation}.',
        ajaxOperations: {
            deleteThumb: 'excluir arquivo',
            uploadThumb: 'enviar arquivo',
            uploadBatch: 'enviar em lote',
            uploadExtra: 'enviar dados de formulário'
        },
